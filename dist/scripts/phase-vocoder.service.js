...
(() => {
  ...
  function process_ola_simd(channel, hann_buffer, pitch_factor, time_cursor, frequency_increment, bands, multiplier2) {
    ...
    const ret = wasm.process_ola_simd(ptr0, len0, channel, ptr1, len1, pitch_factor, time_cursor, frequency_increment, ptr2, len2, ptr3, len3);
  ...
  function __wbg_adapter_41(arg0, arg1) {
    wasm.wasm_bindgen_5f6d3b4572ead63d___convert__closures_____invoke______(arg0, arg1);
  }
  ...
  function __wbg_adapter_100(arg0, arg1, arg2, arg3, arg4) {
    wasm.closure55_externref_shim(arg0, arg1, arg2, arg3, arg4);
  }
  ...
  function __wbg_get_imports() {
    ...
    imports.wbg.__wbg_forEach_d77328dbdd4919da = function(arg0, arg1, arg2) {
      try {
        ...
        var cb0 = (arg02, arg12, arg22) => {
          ...
          state0.a = 0;
          try {
            return __wbg_adapter_100(a, state0.b, arg02, arg12, arg22);
          } finally {
            state0.a = a;
          }
        };
    ...
    imports.wbg.__wbg_log_1d273edd1e4bdb14 = function(arg0, arg1) {
  ...
  var BUFFER_RESET_THRESHOLD = 128;
  var OLAProcessor = class _OLAProcessor extends AudioWorkletProcessor {
    ...
    reallocateChannelsIfNeeded(inputs, outputs, force = false) {
      if (force) {
        for (let i = 0; i < this.nbInputs; ++i) {
      ...
      for (let i = 0; i < this.nbOutputs; ++i) {
        for (let j = 0; j < this.outputBuffers[i].length; ++j) {
          for (let k = 0; k < this.blockSize; ++k) {
            this.outputBuffers[i][j][k] += this.outputBuffersToRetrieve[i][j][k] / this.nbOverlaps * this.gainFactor;
          }
        }
      }
    }
    process(inputs, outputs, params) {
      ...
      if (this.readAndSetInputs(this.inputBuffers, inputs)) {
        ...
        if (this.processCounter === this.processOverlap || this.processCounter === 0) {
          ...
          this.processCounter = 0;
          ++this.bufferResetCounter;
          this.bufferResetCounter &= BUFFER_RESET_THRESHOLD - 1;
        }
  ...
  var PhaseVocoderProcessor = class extends OLAProcessor {
    ...
    async onmessage(data) {
      ...
      } else if (data.hasOwnProperty("gain")) {
        this.gainFactor = data.gain;
      }
    }
    constructor(options) {
